...
class ReservationFormCalendar extends Component
{
    ...
    #[\Livewire\Attributes\On('setCheckInDate')]
    public function handleSetCheckInDate($date, $roomId = null)
    {
        $this->resetForm();
        $this->check_in = $date;
    ...
    #[\Livewire\Attributes\On('openReservationFormCalendar')]
    public function handleOpenReservationFormCalendar($date = null, $roomId = null)
    {
        if ($date) $this->check_in = $date;
        if ($roomId) $this->selectedRoomId = $roomId;
    ...
    private function resetForm()
    {
        ...
        $this->nb_lits_dappoint = 0;
        $this->statut = 'En attente';
        $this->mode_reservation = 'Interne';
        $this->total = 0;
        $this->days = 0;
        $this->amount_due = 0;
    }
    ...
    {
        return view('livewire.reservation.reservation-form-calendar', [
