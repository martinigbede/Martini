...
<div @keydown.escape.window="$wire.closeModal()" 
    ...
    {{-- BACKGROUND --}}
    <div @click="$wire.closeModal()" class="fixed inset-0 bg-brown-900/60"></div>

    <div class="flex items-center justify-center min-h-screen px-4 text-center sm:block sm:p-0">
        <span class="hidden sm:inline-block sm:align-middle sm:h-screen">&#8203;</span>

        {{-- CONTENU DU MODAL --}}
        <div class="inline-block align-bottom bg-white rounded-xl text-left overflow-hidden transform sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full border border-brown-200 shadow-xl">
                ...
                <div class="bg-brown-700 px-6 py-4">
                    <div class="flex justify-between items-center">
                        ...
                        <button type="button" wire:click="closeModal"
                                class="text-brown-200 hover:text-white p-1 rounded">
                            ...
                            <div class="border border-brown-200 p-4 rounded-lg relative bg-white"
                                ...
                                <div class="grid grid-cols-1 gap-3">
                                    <div>
                                        ...
                                        <select wire:model="items.{{ $index }}.menu_id"
                                                wire:change="$refresh"
                                    ...
                                    @if(!empty($units))
                                        <div>
                                            ...
                                            <select wire:model="items.{{ $index }}.unite"
                                                    wire:change="$refresh"
                                                    class="w-full border border-brown-200 rounded text-sm py-2 px-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <input type="number" min="1"
                                                   wire:model="items.{{ $index }}.quantite"
                                                   wire:change="$refresh"
                                ...
                                <div class="flex justify-between items-center mt-3 pt-3 border-t border-brown-100 text-xs">
                                    ...
                                    <div>
                                        <span class="text-brown-600">Total:</span>
